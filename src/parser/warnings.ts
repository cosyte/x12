 ...
 * decode that amount. The money the sender wrote is legible in the document
 * and is on no part of the typed model.
 *
 ...
 * are unreadable, because that route never attempts the decode.
 *
 * @example
 * ```ts
