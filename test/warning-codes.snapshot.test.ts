...
describe("public API: WARNING_CODES surface is stable", () => {
  ...
  it("the registry is additions-only: 21 -> 22 (Phase 8) -> 23 (X12-QUANTITY-SILENT-DEFAULTS) -> 24 (X12-837-SV-SILENT-ZERO) -> 25 (X12-VARIANT-LOOKUP-PROTOTYPE) -> 26 (X12-837-LOOP-RESIDUALS)", () => {
    expect(Object.keys(WARNING_CODES)).toHaveLength(26);
  });
});
