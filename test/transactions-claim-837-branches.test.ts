...
describe("get837Claims - cross-variant SVx segments are ignored and WARNED, never misread", () => {
  ...
  it("837P line ignores an SV3 segment (dental procedure) and warns", () => {
  ...
  it("837I line ignores an SV1 segment (professional procedure) and warns", () => {
